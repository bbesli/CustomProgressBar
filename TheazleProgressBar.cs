...
namespace MayenFileInstaller.CustomProgressBar
{
    ...
    public class TheazleProgressBar : ProgressBar
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            if (!stopPainting)
            {
                ...
                double scaleFector = (((double)this.Value - this.Minimum) / ((double)this.Maximum - this.Minimum));
                int sliderWidth = (int)(this.Width * scaleFector);
